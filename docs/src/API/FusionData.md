...
it records coefficient fields, conventions, provenance, and the categorical
structures supplied by each entry.
...
| $E_6$ data | `E6subfactor` | [$E_6$](../F-symbols/E6.md) |
...
| Vercleyen–Slingerland data | `cat_fr_8122`, `cat_fr_9143` | [Vercleyen–Slingerland data](../F-symbols/VercleyenSlingerland.md) |
