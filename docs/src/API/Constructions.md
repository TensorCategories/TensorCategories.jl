...
| Semisimplification | `semisimplify`, `Semisimplification`, `is_negligible`, `trace_pairing`, `quotient_hom_dimension`, `semisimplified_piece`, `decomposition_isomorphism` | [Semisimplification](../Constructions/Semisimplification.md) |
