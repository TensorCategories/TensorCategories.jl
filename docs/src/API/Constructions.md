...
| Semisimplification | `semisimplify`, `Semisimplification`, `is_negligible`, `trace_pairing`, `quotient_hom_dimension` | [Semisimplification](../Constructions/Semisimplification.md) |
