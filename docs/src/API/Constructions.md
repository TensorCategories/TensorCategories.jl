...
|:---|:---|:---|
| Drinfeld center and half-braidings | `center`, `center_embedding`, `CenterCategory`, `CenterObject`, `half_braiding`, `is_central`, `center_simples`, `induction`, `induction_restriction` | [Half-braidings and computation](../Constructions/Center.md) |
...
| Semisimplification | `semisimplification`, `semisimplify`, `is_negligible`, `trace_pairing`, `quotient_hom_dimension`, `semisimplified_piece`, `decomposition_isomorphism` | [Semisimplification](../Constructions/Semisimplification.md) |
